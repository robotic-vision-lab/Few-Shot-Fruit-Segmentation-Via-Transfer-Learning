...
def dice_loss(true, logits, eps=1e-7,p=1):
    ...
    if num_classes == 1:
        true_1_hot = torch.eye(num_classes + 1).cuda()
    ...
    cardinality = torch.sum(probas**p + true_1_hot**p, dims)
    dice_loss = (2. * intersection / (cardinality + eps)).mean()
    return (1 - dice_loss)

def jaccard_loss(true, logits, eps=1e-7, p=2):
